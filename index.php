<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/i01/0321/19.04/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . '/i01/0321/19.04' . DIRECTORY_SEPARATOR . $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/i01/0321/19.04/project/config/routes.php';
	
	$track = ( new Router )      -> getTrack($routes, $_SERVER['REQUEST_URI']);
	$page  = ( new Dispatcher )  -> getPage($track);
	
	echo (new View) -> render($page);
//Tverdohleb Andrey i-01